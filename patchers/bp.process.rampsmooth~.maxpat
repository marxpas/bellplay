...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 220.0, 12.0, 81.0, 23.0 ],
					"text" : "ears.mc.in~ 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 114.0, 12.0, 81.0, 23.0 ],
					"text" : "ears.mc.in~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 8.0, 51.0, 231.0, 23.0 ],
					"text" : "mc.rampsmooth~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 88.0, 79.0, 23.0 ],
					"text" : "ears.mc.out~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 8.0, 12.0, 71.0, 23.0 ],
					"text" : "ears.mc.in~"
				}
