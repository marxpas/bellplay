...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 334.0, 302.0, 153.0, 23.0 ],
					"style" : "subtlelight",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 81.0, 242.0, 175.0, 23.0 ],
					"style" : "subtlelight",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 237.0, 165.0, 116.0, 23.0 ],
					"style" : "subtlelight",
					"text" : "gate 2 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 527.0, 125.0, 29.5, 23.0 ],
					"style" : "subtlelight",
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.0, 125.0, 29.5, 23.0 ],
					"style" : "subtlelight",
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 498.0, 91.0, 76.0, 23.0 ],
					"style" : "subtlelight",
					"text" : "regexp ^/.*"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 416.0, 91.0, 87.0, 23.0 ],
					"style" : "subtlelight",
					"text" : "regexp ^\\\\..*"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 334.0, 50.0, 183.0, 23.0 ],
					"style" : "subtlelight",
					"text" : "t l l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 7.0, 50.0, 167.0, 23.0 ],
					"style" : "subtlelight",
					"text" : "regexp .*\\\\/(?=(.*\\\\.\\\\w+))"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 334.0, 6.0, 30.0, 30.0 ],
					"style" : "subtlelight"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 334.0, 342.0, 30.0, 30.0 ],
					"style" : "subtlelight"
				}
