...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 324.666666666666629, 183.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 236.0, 240.0, 242.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 337.0, 160.0, 23.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 10.0, 56.5, 92.0, 23.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"out" : "nnnnnnn",
									"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
									"patching_rect" : [ 9.0, 54.0, 437.0, 219.0 ],
									"pitcheditrange" : [ "null" ],
									"showscrollbar" : 0,
									"stafflines" : [ 5 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 9.0, 288.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 83.0, 186.5, 35.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Ableton Sans Medium",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 379.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 83.0, 98.0, 149.0, 23.0 ],
					"text" : "t dump l clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "bang" ],
					"patching_rect" : [ 148.0, 145.0, 284.0, 23.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80300
					}
,
					"text" : "bach.keys roll synth features @out nm @nullmode 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 83.0, 290.0, 421.0, 23.0 ],
					"text" : "ears.roll.synthesis~ @normalize 0 @numchannels 1 @assemble 1 @gainslot 1"
				}
